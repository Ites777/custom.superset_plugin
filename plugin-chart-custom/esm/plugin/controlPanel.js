 ...
 * under the License.
 */
import { smartDateFormatter, t, validateNonEmpty } from '@superset-ui/core';
import { D3_TIME_FORMAT_OPTIONS, formatSelectOptions, sections, sharedControls, emitFilterControl, legacySortBy } from '@superset-ui/chart-controls';
  ...
  controlPanelSections: [{ ...sections.legacyTimeseriesTime,
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        default: 'key_a_to_z',
        choices: [// [value, label]
        ['key_a_to_z', t('key a-z')], ['key_z_to_a', t('key z-a')], ['value_a_to_z', t('value ascending')], ['value_z_to_a', t('value descending')]],
        renderTrigger: true,

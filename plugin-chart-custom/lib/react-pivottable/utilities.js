...
PivotData.forEachRecord = function (input, processRecord) {
  ...
  throw new Error((0, _core.t)('Unknown input format'));
};
...
PivotData.propTypes = {
  ...
  rowOrder: _propTypes.default.oneOf(['key_a_to_z', 'key_z_to_a', 'value_a_to_z', 'value_z_to_a']),
  colOrder: _propTypes.default.oneOf(['key_a_to_z', 'key_z_to_a', 'value_a_to_z', 'value_z_to_a'])
};